...
export function ChatMessageItem({ message, onRetry }: ChatMessageItemProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "flex flex-col gap-1.5 transition-all duration-200 min-w-0",
          isUser
            ? "items-end max-w-[85%] md:max-w-xl ml-auto"
            : "items-start w-full max-w-[96%] md:max-w-3xl",
        )}
      >
        <div
          className={cn(
            "rounded-2xl px-5 py-3.5 shadow-sm relative min-w-0 w-full",
            isUser
        ...
        >
          ...
          <div
            className={cn(
              "text-[15px] leading-relaxed break-words min-w-0",
              isUser
                ? "text-white/95 whitespace-pre-wrap"
                : "text-foreground/90 markdown-body overflow-x-auto",
            )}
          >
            {message.content === "..." ? (
              ...
              <ReactMarkdown
                ...
                components={{
                  ...
                  th({ children }: any) {
                    return (
                      <th className="border border-border/50 bg-muted/50 px-3 py-2 text-left font-semibold">
                        {children}
                      </th>
                    );
                  },
              ...
              <div className="flex items-center bg-background/50 backdrop-blur-md rounded-lg border border-border/40 p-0.5 shadow-sm">
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    feedback === "good" && "text-primary bg-primary/10",
                  )}
                  onClick={() =>
                ...
                >
                  <ThumbsUp
                    size={14}
                    className={feedback === "good" ? "fill-current" : ""}
                  />
                </Button>
                ...
                <Button
                  ...
                  className={cn(
                    "h-8 w-8 text-muted-foreground hover:text-foreground hover:bg-muted/50",
                    feedback === "bad" && "text-destructive bg-destructive/10",
                  )}
                ...
                >
                  <ThumbsDown
                    size={14}
                    className={feedback === "bad" ? "fill-current" : ""}
                  />
                </Button>
                ...
                {onRetry && (
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent
                      align="start"
                      className="w-[200px] p-1.5 border-border shadow-md"
                    >
